...
def fix_atoms():
    ...
    for i in range(10, position_range):
        ...
        for i in range(3):
            atom_position_string += "    " + "{:.10f}".format(float(atom_position_list[i]))
...
text3.place(width = 400, height = 660, x = 10, y = 10)

## Model Type
label7 = Label(tab3, text = "Model Type :", relief = "flat", anchor = "w")
label7.place(width = 200, height = 30, x = 420, y = 10)
...
tn2 = Button(text = "Make All", command = make_all)
tn2.configure(font = ("Arial", 10, "bold"), bg = "#CCCCCC")
tn2.place(width = 120, height = 30, x = 620, y = 720)
